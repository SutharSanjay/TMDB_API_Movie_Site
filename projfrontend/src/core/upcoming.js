...
import { Upcomingfetch } from "../controller"
...
const Upcoming = ()=>{
    ...
    return(
        <div data-aos="zoom-out-left" className="upcoming">
                <h2>Upcoming <Link className="link" to={{pathname:"/upcoming/more"}}><span><button className="btn-popular">Show All</button></span></Link></h2>
